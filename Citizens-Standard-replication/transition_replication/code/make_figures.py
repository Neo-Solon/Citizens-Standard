...
FIG_DIR = "/home/claude/paper3_repl/figures"
...
ax.annotate(f"Public debt retired ~Year {retired}", xy=(retired, 2), xytext=(retired-13, 25),
...
ax.set_title("Figure A.2. Public-debt-to-GDP under Mode T vs CBO current-law baseline\n"
             "Legacy Debt Trust + KT channel (1.5% of M2), primary surplus phasing to 1.5% of GDP",
             fontsize=11, fontweight="bold")
ax.legend(); ax.grid(alpha=0.3); ax.set_ylim(-5, 165)
plt.tight_layout()
...
ax1.set_title("Figure A.2b. KT issuance and the declining public debt stock\n"
              "KT retires the public debt to zero, then deactivates",
              fontsize=11, fontweight="bold")
