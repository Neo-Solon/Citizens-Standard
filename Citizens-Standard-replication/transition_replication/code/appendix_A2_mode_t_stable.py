...
(Neo-Solon, 2026c, Section 4.1 / Appendix A.2). The constitutional-lock
credibility timing of Appendix A.5 is replicated separately in
...
if __name__ == "__main__":
    print("=" * 78)
    print("MODE T-STABLE CONTINUITY (Appendix A.2 self-extinguishing claim)")
    print("=" * 78)
    ...
    print()
    print("  (Constitutional-lock credibility timing is in appendix_A5_lock_credibility.py.)")
