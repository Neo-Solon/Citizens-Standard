...
def fig_M1(results, det_central, fname="figure_M1_distributions_v3.png"):
    ...
    fig.suptitle("Figure M1. Monte Carlo distribution of Stable Floor (full-rate Mode T-stable) at retirement\n"
...
def fig_M3(results, fname="figure_M3_p_below_median_v3.png"):
    ...
    ax.set_ylabel("P(Stable Floor (full-rate Mode T-stable) < median actual retirement wealth)")
...
def fig_M4(results, det_central, fname="figure_M4_p50_p5_sensitivity_v3.png"):
    ...
    fig.suptitle("Figure M4. Sensitivity of Stable Floor (full-rate Mode T-stable) to bootstrap configuration\n"
...
if __name__ == "__main__":
    import time, os
    out_dir = "/home/claude/repl/replication/figures_v3"
    os.chdir(out_dir)
