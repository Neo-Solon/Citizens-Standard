...
Output files:
  figure_M1_distributions.png  -- per-cohort density histograms (IID vs block)
  figure_M2_percentile_bands.png  -- P5/P25/P50/P75/P95 by cohort
  figure_M3_p_below_median.png  -- bars of P(<median) across configs
  figure_M4_p50_p5_sensitivity.png  -- left P50, right P5 by configuration
"""
...
# =============================================================================
def fig_M1(results, det_central, fname="figure_M1_distributions.png"):
...
# =============================================================================
def fig_M2(results, det_central, fname="figure_M2_percentile_bands.png"):
...
# =============================================================================
def fig_M3(results, fname="figure_M3_p_below_median.png"):
    fig, ax = plt.subplots(figsize=(11, 6))
    fig.suptitle("Figure M3. Probability that Mode B falls below median actual retirement outcome\n"
    ...
    ax.set_ylabel("P(Mode B Stable Floor < median actual retirement wealth)")
...
# =============================================================================
def fig_M4(results, det_central, fname="figure_M4_p50_p5_sensitivity.png"):
