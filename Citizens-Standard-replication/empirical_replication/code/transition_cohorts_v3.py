...
RETURN_SCENARIOS = {"pessimistic": 0.030, "central": 0.045, "optimistic": 0.065}
...
def compute_transition_cohort(data, birth, retire, base_return,
    ...
    Identical per-year accounting to deterministic_engine_v3.compute_cohort,
