...
| `verify_psi_plateau.py` | **Appendix A.6:** cumulative citizen ownership plateaus at ψ\* = c·dur under both the constant-hazard and fixed-duration decumulation models (base 0.008·30 = 0.24; high 0.015·30 = 0.45), and is conservative under positive growth (ψ\* = c·annuity(g, dur) ≤ c·dur). |
