"""
paper01_architecture — verifies that `architecture_replication/` still reproduces the numbers the paper publishes.

The package itself is NOT copied here. It stays where the repo keeps it, at
`replication/architecture_replication/`, and remains independently runnable. This adapter only drives it:
...
PKG       = REPL / "architecture_replication"
