"""
paper13_comparative — verifies that `comparative_replication/` still reproduces the numbers the paper publishes.

The package itself is NOT copied here. It stays where the repo keeps it, at
`replication/comparative_replication/`, and remains independently runnable. This adapter only drives it:
...
PKG       = REPL / "comparative_replication"
ENTRY     = 'run_all.py'
ARTIFACTS = [('json', 'results/comparison_results.json')]
