"""
paper08_structural_buyer — verifies that `structural_buyer_replication/` still reproduces the numbers the paper publishes.

The package itself is NOT copied here. It stays where the repo keeps it, at
`replication/structural_buyer_replication/`, and remains independently runnable. This adapter only drives it:
...
PKG       = REPL / "structural_buyer_replication"
