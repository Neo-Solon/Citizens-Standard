"""
paper10_empirical_validation — verifies that `empirical_validation_replication/` still reproduces the numbers the paper publishes.

The package itself is NOT copied here. It stays where the repo keeps it, at
`replication/empirical_validation_replication/`, and remains independently runnable. This adapter only drives it:
...
PKG       = REPL / "empirical_validation_replication"
ENTRY     = 'run_all.py'
ARTIFACTS = [('json', 'results/horserace_results.json')]
