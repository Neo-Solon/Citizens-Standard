"""
paper06_banking — verifies that `banking_replication/` still reproduces the numbers the paper publishes.

The package itself is NOT copied here. It stays where the repo keeps it, at
`replication/banking_replication/`, and remains independently runnable. This adapter only drives it:
