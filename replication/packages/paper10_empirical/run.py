"""
paper10_empirical — verifies that `empirical_replication/` still reproduces the numbers the paper publishes.

The package itself is NOT copied here. It stays where the repo keeps it, at
`replication/empirical_replication/`, and remains independently runnable. This adapter only drives it:
...
PKG       = REPL / "empirical_replication"
ENTRY     = 'run_all.py'
